		...
		return (
			<Card className="w-full">
				...
				<CardContent className="space-y-4">
					<p className="text-muted-foreground">
						Unable to load your verification status. Please try
						again.
					</p>
				...
				<CardContent className="space-y-3 text-sm">
					{status === "PENDING" && (
						<div className="space-y-2">
							<p>
								🔍 Our admin team is reviewing your account and
								documents
							</p>
							<p>
							...
							<p>
								⏱️ This process usually takes 1-2 business days
							</p>
							<p>
								🔄 This page will automatically refresh every 30
								seconds
							</p>
						</div>
					)}
					{status === "APPROVED" && (
						<div className="space-y-2">
							...
							<p>
								🚀 Click "Continue to Dashboard" to get started
							</p>
						</div>
					)}
					{status === "REJECTED" && (
						<div className="space-y-2">
							...
							<p>
								📝 Please review the notes above for specific
								feedback
							</p>
							<p>
