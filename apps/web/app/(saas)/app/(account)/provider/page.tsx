							...
							<div className="flex items-center space-x-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground mt-1">
										Manage your services, bookings, and
										provider profile
									</p>
								</div>
							</div>
				...
				<div className="space-y-8">
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card className="group hover:shadow-xl hover:shadow-primary/20 transition-all duration-500 border-0 bg-card/70 backdrop-blur-lg hover:bg-card/80 cursor-pointer transform hover:scale-[1.02] hover:translate-x-1 hover:translate-y-1">
							...
							<CardContent>
								<div className="text-3xl font-bold text-foreground transition-all duration-300 group-hover:text-primary group-hover:scale-105 group-hover:-rotate-1">
									{stats?.revenue.total
										? `$${stats.revenue.total}`
										: "$0"}
								</div>
									...
									{isBookingsLoading ? (
										...
										<div className="space-y-3">
											{recentBookings.bookings.map(
												(booking) => (
													<div
														key={booking.id}
														className="flex justify-between items-center p-3 bg-accent/20 rounded-lg hover:bg-accent/30 transition-all"
													>
														<div className="flex items-center space-x-3">
										...
										<div className="text-center p-8 bg-accent/20 rounded-lg">
											...
											<p className="text-xs text-muted-foreground">
												...
												once students start booking your
												services
											</p>
										</div>
									)}
