				...
				<Card className="w-full max-w-md">
					...
					<CardContent className="space-y-4">
						<p className="text-muted-foreground">
							You must be logged in to access the provider
							dashboard.
						</p>
					...
					<CardContent className="space-y-4">
						<p className="text-muted-foreground">
							...
							{user?.userType === "STUDENT"
								? " Students can browse services from the main app."
								: ""}
						</p>
						<Button asChild className="w-full">
							<Link href="/app">Go to Main App</Link>
						</Button>
					</CardContent>
				</Card>
			</div>
		...
		return (
			<div className="flex items-center justify-center min-h-screen">
				<Card className="w-full max-w-md">
					...
					<CardContent className="space-y-4">
						<p className="text-muted-foreground">
							Please complete your provider onboarding before
		...
		return (
			<div className="flex items-center justify-center min-h-screen">
				<Card className="w-full max-w-md">
					...
					<CardContent className="space-y-4">
						<p className="text-muted-foreground">
							Your provider account is pending verification. You
							can access limited features while we review your
							application.
						</p>
						<Button asChild className="w-full">
