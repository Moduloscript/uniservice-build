					...
					<div className="space-y-4">
						<div className="space-y-2">
							...
							<p className="text-sm text-muted-foreground">
								Make it easy for students to understand what
								you're offering at a glance.
							</p>
						</div>
						<div className="space-y-2">
							<h4 className="font-medium">
							...
							<p className="text-sm text-muted-foreground">
								Include what's covered, your expertise, and what
						...
						<div className="space-y-2">
							...
							<p className="text-sm text-muted-foreground">
								Research similar services to ensure your pricing
						...
						<div className="space-y-2">
							...
							<p className="text-sm text-muted-foreground">
								Select the most appropriate category to help
								students find your service easily.
							</p>
						</div>
					</div>
				</CardContent>
