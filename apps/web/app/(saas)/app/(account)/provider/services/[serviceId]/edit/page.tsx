...
export default function EditServicePage({ params }: { params: { serviceId: string } }) {
  ...
  const updateServiceMutation = useMutation({
    mutationFn: async (data: UpdateServiceFormData) => updateService(params.serviceId, data),
    onSuccess: () => {
    ...
    onError: (error) => {
      ...
      toast.error(error instanceof Error ? error.message : "Failed to update service. Please try again.");
    },
  });
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="space-y-2">
              <h4 className="font-medium">Make Clear and Concise Updates</h4>
              <p className="text-sm text-muted-foreground">
                Ensure any changes you make enhance student understanding of your service.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="font-medium">Highlight Key Benefits</h4>
              <p className="text-sm text-muted-foreground">
                Emphasize what sets your service apart from others and why students should book with you.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="font-medium">Review Pricing Regularly</h4>
              <p className="text-sm text-muted-foreground">
                Regularly assess market trends to ensure your pricing remains competitive.
              </p>
            </div>
          </div>
        </CardContent>
