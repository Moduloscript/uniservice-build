		...
		<div className="space-y-6">
			...
			<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
				...
				<Card>
					<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<Badge
							status={
								service.status === "active" ? "success" : "info"
							}
						>
				...
				<Card>
					...
					<CardContent>
						<div className="grid gap-3">
							...
							>
								<Link
									href={`/app/provider/services/${service.id}/outcomes`}
								>
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Customize what's included with your service to attract
						more bookings
					</CardDescription>
				</CardHeader>
				<CardContent>
					<div className="space-y-4">
						<p className="text-sm text-muted-foreground">
							Features help students understand what they'll get
							when they book your service. The more detailed and
							specific you are, the more likely students are to
							book.
						</p>
