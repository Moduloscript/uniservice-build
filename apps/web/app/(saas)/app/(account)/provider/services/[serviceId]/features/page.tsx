...
import type { ServiceFeature } from "@/modules/services/types/service-feature";

export default function ProviderFeaturesManagementPage({
	params,
	...
	const [editingFeature, setEditingFeature] = useState<ServiceFeature | null>(
		null,
	);
	...
	const handleAddFeature = (
		data: Omit<ServiceFeature, "id" | "serviceId">,
	) => {
		addFeature(data);
	};
			...
			<Card>
				...
				<CardContent>
					<p className="text-muted-foreground">
						Here are the features available for your service. Add
						new features, edit or remove existing ones, and reorder
