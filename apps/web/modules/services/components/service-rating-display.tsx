...
const reviewStatsQueryKey = (serviceId: string) => ["reviews", "stats", serviceId] as const;

export function ServiceRatingDisplay({ serviceId, initialStats }: ServiceRatingDisplayProps) {
