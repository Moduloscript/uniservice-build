...
import type { ServiceOutcome, CreateServiceOutcomeData, UpdateServiceOutcomeData } from "../types/service-outcome";
...
interface OutcomeManagementFormProps {
  ...
  onSubmit: (data: CreateServiceOutcomeData | UpdateServiceOutcomeData) => void;
  onCancel?: () => void;
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Learning Outcome Title *</FormLabel>
                  <FormControl>
                    <Input 
                      {...field} 
                  ...
                  <FormDescription>
                    A clear, specific learning goal students will achieve
                  </FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Add specifics about skills, knowledge, or abilities students will gain
                  </FormDescription>
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <FormMessage />
