...
export function useFileUpload({
	...
	async function uploadFile(
		...
		if (currentUploadRef.current || lastUploadHashRef.current === fileHash) {
			console.log('Duplicate file upload prevented:', { fileHash, isCurrentlyUploading: !!currentUploadRef.current });
