...
export const submitOnboardingAtom = atom(
	...
	async (
		...
		set,
		{
			data,
			router,
		}: { data: OnboardingFormValues; router: ReturnType<typeof useRouter> },
	) => {
...
export const resetSubmissionStateAtom = atom(null, (get, set) => {
	set(hasSubmittedAtom, false);
	set(isLoadingAtom, false);
	set(serverErrorAtom, null);
});
