...
export function VerificationRejected({
  ...
  return (
    <Wrapper>
      ...
      <Text>
        We've reviewed your account verification, but we need you to update some information before we can approve your account.
      </Text>
      ...
      <Text>
        Please review the feedback above and update your information accordingly. Common issues include:
        <ul>
      ...
      <Text className="text-muted-foreground text-sm mt-6">
        Don't worry - this is a common part of the verification process. Once you update your information, our team will review it promptly.
      </Text>
