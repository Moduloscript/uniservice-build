...
export const debugUserRouter = new Hono()
  ...
  .get("/user",
                ...
                properties: {
                  ...
                  debugInfo: {
                    ...
                    properties: {
                      ...
                      canAccessProviderDashboard: { type: "boolean" }
                    }
                  }
                }
              }
    ...
    async (c) => {
      ...
      const debugInfo = {
        ...
        canAccessProviderDashboard: user.userType === "PROVIDER" && user.onboardingComplete
      };
  ...
  .get("/refresh-session",
    describeRoute({
      ...
      description: "Force refresh the current session to pull latest user data from database",
      responses: {
        200: {
